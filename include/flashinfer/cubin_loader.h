...
#else
#define FLASHINFER_CUBIN_LOADER_EXPORT __attribute__((visibility("default")))
#endif
...
extern "C" FLASHINFER_CUBIN_LOADER_EXPORT void FlashInferSetCurrentCubin(const char* binary,
                                                                         int size) {
